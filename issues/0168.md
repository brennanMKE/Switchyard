...
5. **Scratch verification of all three changes**, from `git archive` of `8e1bf3c` with #0167's
   ...
   green at 685. File shasums as verified:
...
- [ ] Round 2: `cd YardKit && swift test` prints the count line you paste. `docs/test-baseline.txt`
      ...
      with today's numbers, `Test run with 696 tests` (674 + 10 + 12), all passing. Do not run
      the suite before writing Change 3; the baseline is already measured and stated here.
